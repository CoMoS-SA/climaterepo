...
* Choose to retrieve raw climate data about (minimum, average, and maximum) temperature, precipitation and SPEI (Standardized Precipitation-Evapotranspiration Index) from different sources and geographical/time resolutions;
...
* *Climate variable*: available climate variables are (minimum, average, and maximum) temperature and precipitation (daily, monthly and annual observations), and SPEI (standardized precipitation-evapotranspiration index; monthly observations);
