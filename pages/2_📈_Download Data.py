...
if st.session_state.time_frequency == 'daily' or st.session_state.threshold_dummy == 'True':
    ...
    if st.session_state.source == 'ERA5' and st.session_state.geo_resolution in ['gadm_world', 'gadm2', 'nuts0', 'nuts1', 'nuts2', 'nuts3'] and variable == 'pre' and st.session_state.ending_year == 2025:
        time_range = time_range[:-1] # Remove last day of 2025 as missing from data
else:
